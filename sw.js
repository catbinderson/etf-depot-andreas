const CACHE="etf-depot-andreas-v10-cloud-pro-1";
const ASSETS=["./","./index.html","./styles.css?v=10.0.0","./app.js?v=10.0.0","./manifest.webmanifest","./icon-192.png","./icon-512.png"];
