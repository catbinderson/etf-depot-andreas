const CACHE="etf-depot-andreas-v10-2-cloud-verified";
const ASSETS=["./","./index.html","./styles.css?v=10.2.0","./app.js?v=10.2.0","./manifest.webmanifest","./icon-192.png","./icon-512.png"];
