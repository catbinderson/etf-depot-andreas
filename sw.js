const CACHE="etf-depot-andreas-v1-3-persistent-login";
const ASSETS=["./","./index.html","./styles.css?v=1.3.0","./app.js?v=1.3.0","./manifest.webmanifest","./icon-192.png","./icon-512.png"];
