const CACHE="etf-depot-andreas-v10-1-cloud-final";
const ASSETS=["./","./index.html","./styles.css?v=10.1.0","./app.js?v=10.1.0","./manifest.webmanifest","./icon-192.png","./icon-512.png"];
