const CACHE="etf-depot-andreas-v14-pro-dashboard-2";
const ASSETS=["./","./index.html","./styles.css?v=14.1.0","./app.js?v=14.1.0","./manifest.webmanifest","./icon-192.png","./icon-512.png"];
