const CACHE="etf-depot-andreas-v1-5-7-metric-changes";
const ASSETS=["./","./index.html","./styles.css?v=1.5.7","./app.js?v=1.5.7","./manifest.webmanifest","./icon-192.png","./icon-512.png","./version.json"];
  ...
  if(data.type==="PREPARE_UPDATE"){
    event.waitUntil((async()=>{
      try{
        ...
        const jsResp=await cache.match("./app.js?v=1.5.7");
